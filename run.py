...
class JobDispatcher:
  ...
  def launchOneParameterizedRun(self, counter, params):
    ...
    if self.platform == 'Local':
      ...
      command = 'python3 '+params['whichTest']+'.py'
      ...
      script.writelines('time srun python3 '+params['whichTest']+'.py \n')
      script.close()
      ...
      if self.sim_counter == 0:
        ...
        os.system('echo "python3 ' + params['whichTest'] + '.py" >> ' + IDstring + '/firestarter.sh')
...
def main():
    ...
    RequiredNamed.add_argument('--platform', type=str, help='Run the experiment on which platform?', required=True, choices=['Local', 'LocalParallel', 'Sango', 'SangoArray', 'K'])
