...
#
#-----------------------------------------------------------------------
def checkSelec(showRasters=False,params={},CSNFR=[2.,10.], PActiveCSN=1., PTNFR=[15.,35], PActivePTN=1., antagInjectionSite='none',antag='', CMPfFR=[4., 4.], PActiveCMPf=1., transientCMPf=1., simDuration=1000., activityLevels = None):
